    ...
    <div class="container">
        ...
        <div class="header">
            <div class="logo">
                <h1>
                    <a href="#">
                        <img class="logo-img center-block" src="/static/images/home/logo.png" height="130px" width="130px" alt="" /> 猫狗生活
                    </a>
                </h1>
            </div>
...
<section class="footer-w3">
    <div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 footer-agile1" data-aos="zoom-in">
            <h3>联系方式</h3>
            <p>电话&nbsp;&nbsp;<span style="font-size: 22px;color: red">17861514578</span></p>
            <br>
            <p>邮件&nbsp;&nbsp;<span style="font-size: 22px;color: red">wuyubo0124@aliyun.com</span></p>
            <br>
